    ...
    <div className={`pop-up-wrapper ${isShowPopup && 'popup-show'}`}>
      ...
      <div className="pop-up py-7 px-10 flex justify-center flex-col items-center">
        ...
        <div className="pop-up-button flex">
          <button className="bg-blue-600 w-[70px] p-3 mx-1 pr-6 pl-6 rounded-2xl flex justify-center items-center text-[white] text-[1.4rem] hover:bg-blue-400">
            <Link to="/login">Sure</Link>
          </button>
          <button
